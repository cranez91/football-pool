...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12 mt-4">
            ...
            <div class="card">
                <div class="card-header bg-secondary text-center text-black">Resultados</div>
                ...
                <div class="card-body bg-dark-blue">
                    ...
                    @guest
                        <div class="text-center">
                            <a  class="btn bg-primary text-black mb-2 btn-md"role="button" href="/register"> Registrate </a>
                            /
                            <a  class="btn bg-primary text-black mb-2 btn-md"role="button" href="/login"> inicia sesión </a>
                            para ver los participantes de la jornada
                        </div>
                    @endguest
                </div>
            </div>
